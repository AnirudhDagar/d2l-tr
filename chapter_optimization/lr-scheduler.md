...
Burada $\eta_0$ başlangıç öğrenme oranı, $\eta_T$ zaman $T$ hedef oranıdır. Ayrıca, $t > T$ için değeri tekrar arttırmadan $\eta_T$'ya sabitledik. Aşağıdaki örnekte, maksimum güncelleme adımı $T = 20$'yi ayarladık.
